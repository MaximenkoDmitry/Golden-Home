...
namespace GOLDENHOMEPROJECT {
	...
	/// <summary>
	/// Сводка для UserBuildingForm
	/// </summary>
	public ref class UserBuildingForm : public System::Windows::Forms::Form
	{
	public:
		UserBuildingForm(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(UserBuildingForm::typeid));
			...
			this->rightPrice->Location = System::Drawing::Point(894, 152);
			...
			this->exit->Location = System::Drawing::Point(21, 33);
			this->exit->Name = L"exit";
			this->exit->Size = System::Drawing::Size(114, 35);
			this->exit->TabIndex = 36;
			this->exit->Text = L"Назад";
			this->exit->UseVisualStyleBackColor = false;
			this->exit->Click += gcnew System::EventHandler(this, &UserBuildingForm::exit_Click);
			// 
			// leftPrice
			// 
			this->leftPrice->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->leftPrice->Location = System::Drawing::Point(792, 152);
			...
			this->Search->Location = System::Drawing::Point(750, 203);
			this->Search->Name = L"Search";
			this->Search->Size = System::Drawing::Size(197, 35);
			this->Search->TabIndex = 37;
			this->Search->Text = L"Поиск";
			this->Search->UseVisualStyleBackColor = false;
			this->Search->Click += gcnew System::EventHandler(this, &UserBuildingForm::Search_Click);
			// 
			// dataGridView1
			// 
			...
			this->dataGridView1->Size = System::Drawing::Size(716, 473);
			...
			this->label4->Location = System::Drawing::Point(745, 152);
			...
			this->label3->Location = System::Drawing::Point(849, 152);
			...
			this->label2->Location = System::Drawing::Point(745, 108);
			...
			this->NameBuilding->Location = System::Drawing::Point(367, 15);
			this->NameBuilding->Name = L"NameBuilding";
			this->NameBuilding->Size = System::Drawing::Size(242, 69);
			this->NameBuilding->TabIndex = 31;
			this->NameBuilding->Text = L"Здание";
			// 
			// UserBuildingForm
			// 
			...
			this->Name = L"UserBuildingForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"UserBuildingForm";
			this->Shown += gcnew System::EventHandler(this, &UserBuildingForm::UserBuildingForm_Shown);
...
private: System::Void UserBuildingForm_Shown(System::Object^ sender, System::EventArgs^ e);
	   void HeaderBuilding();
	   void ShowBuildingUser(vector <Non_Residential_Building> _buildings );
};
}
