//форма администратора с доступом к разделу Помещения
...
System::Void GOLDENHOMEPROJECT::OfficeForm::вПрограммуToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
...
//сохранение в файл
System::Void GOLDENHOMEPROJECT::OfficeForm::вФайлToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	button1->Visible = false;
...
System::Void GOLDENHOMEPROJECT::OfficeForm::Add_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	try {
		...
		MessageBox::Show("Помещение успешно добавлено!", "Внимание");
		txtSurname->Clear();
		txtName->Clear();
		txtPhone->Clear();
		txtAdress->Clear();
...
//удалить выбранный
System::Void GOLDENHOMEPROJECT::OfficeForm::выбранныйToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	button1->Visible = false;
	try {
		if (dataGridView1->RowCount == 1) {
...
//удалить все
System::Void GOLDENHOMEPROJECT::OfficeForm::всеToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	button1->Visible = false;
	try {
		if (dataGridView1->RowCount == 1) {
...
void GOLDENHOMEPROJECT::OfficeForm::Header()
{
	...
	dataGridView1->TopLeftHeaderCell->Value = "Офисы";
	dataGridView1->AutoResizeColumns();
}
...
System::Void GOLDENHOMEPROJECT::OfficeForm::button1_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	try {
		...
		MessageBox::Show("Помещение изменено!", "Внимание");
		txtSurname->Clear();
		txtName->Clear();
		txtPhone->Clear();
		txtAdress->Clear();
