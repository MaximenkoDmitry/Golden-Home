...
namespace GOLDENHOMEPROJECT {
	...
	/// <summary>
	/// Сводка для UserPlotForm
	/// </summary>
	public ref class UserPlotForm : public System::Windows::Forms::Form
	{
	public:
		UserPlotForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(UserPlotForm::typeid));
			...
			this->rightPrice->Location = System::Drawing::Point(903, 148);
			this->rightPrice->Name = L"rightPrice";
			this->rightPrice->Size = System::Drawing::Size(51, 27);
			this->rightPrice->TabIndex = 48;
			// 
			// exit
			// 
			...
			this->exit->Location = System::Drawing::Point(17, 30);
			this->exit->Name = L"exit";
			this->exit->Size = System::Drawing::Size(114, 35);
			this->exit->TabIndex = 46;
			this->exit->Text = L"Назад";
			this->exit->UseVisualStyleBackColor = false;
			this->exit->Click += gcnew System::EventHandler(this, &UserPlotForm::exit_Click);
			// 
			// leftPrice
			// 
			this->leftPrice->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->leftPrice->Location = System::Drawing::Point(801, 148);
			this->leftPrice->Name = L"leftPrice";
			this->leftPrice->Size = System::Drawing::Size(51, 27);
			this->leftPrice->TabIndex = 45;
			// 
			// Search
			// 
			...
			this->Search->Location = System::Drawing::Point(759, 199);
			this->Search->Name = L"Search";
			this->Search->Size = System::Drawing::Size(197, 35);
			this->Search->TabIndex = 47;
			this->Search->Text = L"Поиск";
			this->Search->UseVisualStyleBackColor = false;
			this->Search->Click += gcnew System::EventHandler(this, &UserPlotForm::Search_Click);
			// 
			// dataGridView1
			// 
			this->dataGridView1->BackgroundColor = System::Drawing::Color::White;
			this->dataGridView1->ColumnHeadersHeightSizeMode = System::Windows::Forms::DataGridViewColumnHeadersHeightSizeMode::AutoSize;
			this->dataGridView1->Location = System::Drawing::Point(17, 104);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(729, 473);
			...
			this->label4->Location = System::Drawing::Point(754, 148);
			...
			this->label3->Location = System::Drawing::Point(858, 148);
			...
			this->label2->Location = System::Drawing::Point(754, 104);
			...
			this->NameBuilding->Location = System::Drawing::Point(363, 12);
			this->NameBuilding->Name = L"NameBuilding";
			this->NameBuilding->Size = System::Drawing::Size(261, 69);
			this->NameBuilding->TabIndex = 41;
			this->NameBuilding->Text = L"Участки";
			// 
			// UserPlotForm
			// 
			...
			this->Name = L"UserPlotForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"UserPlotForm";
			this->Shown += gcnew System::EventHandler(this, &UserPlotForm::UserPlotForm_Shown);
...
private: System::Void UserPlotForm_Shown(System::Object^ sender, System::EventArgs^ e);
	   void ShowPlotUser(vector <Not_Residential_Properties> _rooms);
	   void HeaderPlotUser();
};
}
