...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(FlatForm::typeid));
			...
			this->dataGridView1->Location = System::Drawing::Point(0, 303);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(749, 273);
			...
			this->âÏğîãğàììóToolStripMenuItem->Click += gcnew System::EventHandler(this, &FlatForm::âÏğîãğàììóToolStripMenuItem_Click);
			// 
			...
			this->âÔàéëToolStripMenuItem->Click += gcnew System::EventHandler(this, &FlatForm::âÔàéëToolStripMenuItem_Click);
			// 
			// Display
			// 
			...
			this->Display->Click += gcnew System::EventHandler(this, &FlatForm::Display_Click);
			// 
			// Add
			// 
			...
			this->Add->Click += gcnew System::EventHandler(this, &FlatForm::Add_Click);
			// 
			// Change
			// 
			...
			this->Change->Click += gcnew System::EventHandler(this, &FlatForm::Change_Click);
			// 
			// Delete
			// 
			...
			this->âûáğàííûéToolStripMenuItem->Click += gcnew System::EventHandler(this, &FlatForm::âûáğàííûéToolStripMenuItem_Click);
			// 
			...
			this->âñåToolStripMenuItem->Click += gcnew System::EventHandler(this, &FlatForm::âñåToolStripMenuItem_Click);
			// 
			// txtNumOfFloor
			// 
			...
			this->label10->Location = System::Drawing::Point(396, 135);
			this->label10->Name = L"label10";
			this->label10->Size = System::Drawing::Size(74, 26);
			this->label10->TabIndex = 99;
			this->label10->Text = L"İòàæ:";
			// 
			// txtYearBuilt
			// 
			...
			this->label9->Location = System::Drawing::Point(396, 170);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(168, 26);
			this->label9->TabIndex = 97;
			this->label9->Text = L"Ãîä ïîñòğîéêè:";
			// 
			// txtPrice
			// 
			...
			this->txtPrice->Location = System::Drawing::Point(196, 202);
			...
			this->label8->Location = System::Drawing::Point(40, 202);
			...
			this->txtComment->Location = System::Drawing::Point(607, 202);
			...
			this->label4->Location = System::Drawing::Point(396, 205);
			...
			this->label7->Location = System::Drawing::Point(396, 99);
			...
			this->txtAdress->Location = System::Drawing::Point(196, 167);
			this->txtAdress->Name = L"txtAdress";
			this->txtAdress->Size = System::Drawing::Size(148, 29);
			this->txtAdress->TabIndex = 90;
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(40, 167);
			...
			this->label5->Location = System::Drawing::Point(396, 58);
			...
			this->txtPhone->Location = System::Drawing::Point(196, 132);
			...
			this->label3->Location = System::Drawing::Point(40, 132);
			...
			this->txtName->Location = System::Drawing::Point(196, 96);
			...
			this->txtSurname->Location = System::Drawing::Point(196, 61);
			...
			this->NewUser->Location = System::Drawing::Point(499, 2);
			this->NewUser->Name = L"NewUser";
			this->NewUser->Size = System::Drawing::Size(150, 35);
			this->NewUser->TabIndex = 79;
			this->NewUser->Text = L"Êâàğòèğà";
			// 
			// labell
			// 
			...
			this->labell->Location = System::Drawing::Point(40, 61);
			...
			this->Clear->Location = System::Drawing::Point(45, 253);
			this->Clear->Name = L"Clear";
			this->Clear->Size = System::Drawing::Size(192, 31);
			this->Clear->TabIndex = 127;
			this->Clear->Text = L"Î÷èñòèòü ïîëÿ";
			this->Clear->UseVisualStyleBackColor = false;
			this->Clear->Click += gcnew System::EventHandler(this, &FlatForm::Clear_Click);
			// 
			// ChangeSave
			// 
			...
			this->ChangeSave->Location = System::Drawing::Point(551, 253);
			...
			this->ChangeSave->Click += gcnew System::EventHandler(this, &FlatForm::ChangeSave_Click);
			// 
			// FlatForm
			// 
			...
			this->Name = L"FlatForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"FlatForm";
			this->Shown += gcnew System::EventHandler(this, &FlatForm::FlatForm_Shown);
...
private: System::Void FlatForm_Shown(System::Object^ sender, System::EventArgs^ e);
void Header();
void Show();
