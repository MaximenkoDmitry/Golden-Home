...
namespace GOLDENHOMEPROJECT {
	...
	/// <summary>
	/// Сводка для UserRoomForm
	/// </summary>
	public ref class UserRoomForm : public System::Windows::Forms::Form
	{
	public:
		UserRoomForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(UserRoomForm::typeid));
			...
			this->rightPrice->Location = System::Drawing::Point(904, 147);
			...
			this->exit->Location = System::Drawing::Point(24, 31);
			this->exit->Name = L"exit";
			this->exit->Size = System::Drawing::Size(114, 35);
			this->exit->TabIndex = 46;
			this->exit->Text = L"Назад";
			this->exit->UseVisualStyleBackColor = false;
			this->exit->Click += gcnew System::EventHandler(this, &UserRoomForm::exit_Click);
			// 
			// leftPrice
			// 
			this->leftPrice->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->leftPrice->Location = System::Drawing::Point(802, 147);
			...
			this->Search->Location = System::Drawing::Point(760, 198);
			this->Search->Name = L"Search";
			this->Search->Size = System::Drawing::Size(197, 35);
			this->Search->TabIndex = 47;
			this->Search->Text = L"Поиск";
			this->Search->UseVisualStyleBackColor = false;
			this->Search->Click += gcnew System::EventHandler(this, &UserRoomForm::Search_Click);
			// 
			// dataGridView1
			// 
			this->dataGridView1->BackgroundColor = System::Drawing::Color::White;
			this->dataGridView1->ColumnHeadersHeightSizeMode = System::Windows::Forms::DataGridViewColumnHeadersHeightSizeMode::AutoSize;
			this->dataGridView1->Location = System::Drawing::Point(24, 103);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(723, 473);
			...
			this->label4->Location = System::Drawing::Point(755, 147);
			...
			this->label3->Location = System::Drawing::Point(859, 147);
			...
			this->label2->Location = System::Drawing::Point(755, 103);
			...
			this->NameBuilding->Location = System::Drawing::Point(370, 13);
			this->NameBuilding->Name = L"NameBuilding";
			this->NameBuilding->Size = System::Drawing::Size(289, 69);
			this->NameBuilding->TabIndex = 41;
			this->NameBuilding->Text = L"Комнаты";
			// 
			// UserRoomForm
			// 
			...
			this->Name = L"UserRoomForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"UserRoomForm";
			this->Shown += gcnew System::EventHandler(this, &UserRoomForm::UserRoomForm_Shown);
...
private: System::Void UserRoomForm_Shown(System::Object^ sender, System::EventArgs^ e);
	   void ShowRoomUser(vector <Residential_Property> _rooms);
	   void HeaderRoomUser();
};
}
