...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->âÏğîãğàììóToolStripMenuItem->Click += gcnew System::EventHandler(this, &RoomForm::âÏğîãğàììóToolStripMenuItem_Click);
			// 
			...
			this->âÔàéëToolStripMenuItem->Click += gcnew System::EventHandler(this, &RoomForm::âÔàéëToolStripMenuItem_Click);
			// 
			// Display
			// 
			...
			this->âûáğàííûéToolStripMenuItem->Click += gcnew System::EventHandler(this, &RoomForm::âûáğàííûéToolStripMenuItem_Click);
			// 
			...
			this->âñåToolStripMenuItem->Click += gcnew System::EventHandler(this, &RoomForm::âñåToolStripMenuItem_Click);
			// 
			// txtNumOfFloor
			// 
